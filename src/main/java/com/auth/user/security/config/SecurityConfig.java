...
/**
 * Security configuration class for OAuth2 authorization server.
 */
@Configuration
@EnableWebSecurity
...
//    }
    ...
    /**
     * Provides an AuthorizationServerSettings bean.
